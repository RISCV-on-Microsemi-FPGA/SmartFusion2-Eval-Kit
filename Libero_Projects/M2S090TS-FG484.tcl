set project_folder_name_axi MiV_AXI_SF2_Eval_Kit_TS
set project_dir_axi "./$project_folder_name_axi"
set Libero_project_name_axi MiV_AXI_BaseDesign

set project_folder_name_ahb MiV_AHB_SF2_Eval_Kit_TS
...
proc create_new_project_label_axi { }\
{
	...
	puts "----------MiV_RV32IMA_L1_AXI_BaseDesign_SF2_EVAL_KIT_TS------------------"
    puts "-------------------------------------------------------------------------"
	puts "-------------------------------------------------------------------------"
}
...
proc create_new_project_label_ahb { }\
{
    ...
    puts "-------------------------------------------------------------------------"
    puts "-----------------------CREATING NEW PROJECT------------------------------"
	puts "----------MiV_RV32IMA_L1_AHB_BaseDesign_SF2_EVAL_KIT_TS------------------"
    puts "-------------------------------------------------------------------------"
	puts "-------------------------------------------------------------------------"
}
...
# ##
	...
	if {"$target" == "AHB"} then {
		export_prog_job \
			-job_file_name {BaseDesign_SF2_Eval_Kit_TS_AHB_ProgramFile} \
		...
		export_prog_job \
			-job_file_name {BaseDesign_SF2_Eval_Kit_TS_AXI_ProgramFile} \
			-export_dir {./../FlashPro_Express_Projects/Programming_Files} \
			-bitstream_file_type {TRUSTED_FACILITY} \
			-bitstream_file_components {}
		save_project
