## SmartFusion2 Security Evaluation Kit Mi-V Sample FPGA Designs
This folder contains Tcl scripts that build Libero SoC (**v12.3**) design projects for the SmartFusion2 Security Evaluation Kit. These scripts are executed in Libero SoC to generate the sample designs.
