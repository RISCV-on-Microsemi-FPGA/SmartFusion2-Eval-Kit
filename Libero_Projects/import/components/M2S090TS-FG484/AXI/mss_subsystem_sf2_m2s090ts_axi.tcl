# Creating SmartDesign MSS_SUBSYSTEM_sb_0_sb
set sd_name {MSS_SUBSYSTEM_sb_0_sb}
...
"INIT:0000007F90000044574000F18C2309C231839DC0040414180F818" \
...
# Add MSS_SUBSYSTEM_sb_0_sb_MSS_0 instance

sd_instantiate_component -sd_name ${sd_name} -component_name {MSS_SUBSYSTEM_sb_0_sb_MSS} -instance_name {MSS_SUBSYSTEM_sb_0_sb_MSS_0}
#sd_create_pin_group -sd_name ${sd_name} -group_name {MDDR_PADS} -instance_name {MSS_SUBSYSTEM_sb_0_sb_MSS_0} -pin_names {"MDDR_DQS_TMATCH_0_OUT" "MDDR_CAS_N" "MDDR_CLK" "MDDR_CLK_N" "MDDR_CKE" "MDDR_CS_N" "MDDR_ODT" "MDDR_RAS_N" "MDDR_RESET_N" "MDDR_WE_N" "MDDR_ADDR" "MDDR_BA" "MDDR_DQS_TMATCH_0_IN" "MDDR_DM_RDQS" "MDDR_DQ" "MDDR_DQS" }
sd_update_instance -sd_name ${sd_name} -instance_name {MSS_SUBSYSTEM_sb_0_sb_MSS_0}
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORECONFIGP_0:APB_S_PCLK" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_APB_S_PCLK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORECONFIGP_0:APB_S_PRESET_N" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_APB_S_PRESET_N" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESETP_0:M3_RESET_N" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:M3_RESET_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESETP_0:MDDR_DDR_AXI_S_CORE_RESET_N" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_DDR_CORE_RESET_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESETP_0:RESET_N_F2M" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MSS_RESET_N_F2M" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"FAB_CCC_GL1" "CCC_0:GL1" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FAB_CCC_LOCK" "FIC_0_LOCK" "MSS_DDR_FIC_SUBSYSTEM_LOCK" "CCC_0:LOCK" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MCCC_CLK_BASE_PLL_LOCK" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_0_CLK" "CCC_0:GL0" "CORERESETP_0:CLK_BASE" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MCCC_CLK_BASE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"INIT_DONE" "CORECONFIGP_0:INIT_DONE" "CORERESETP_0:INIT_DONE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MDDR_CAS_N" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_CAS_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MDDR_CKE" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_CKE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MDDR_CLK" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_CLK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MDDR_CLK_N" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_CLK_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MDDR_CS_N" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_CS_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MDDR_DQS_TMATCH_0_IN" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_DQS_TMATCH_0_IN" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MDDR_DQS_TMATCH_0_OUT" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_DQS_TMATCH_0_OUT" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MDDR_ODT" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_ODT" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MDDR_RAS_N" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_RAS_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MDDR_RESET_N" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_RESET_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MDDR_WE_N" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_WE_N" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORECONFIGP_0:FIC_2_APB_M_PCLK" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:FIC_2_APB_M_PCLK" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORECONFIGP_0:FIC_2_APB_M_PRESET_N" "CORERESETP_0:FIC_2_APB_M_PRESET_N" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:FIC_2_APB_M_PRESET_N" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORERESETP_0:RESET_N_M2F" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MSS_RESET_N_M2F" }
...
sd_connect_pins -sd_name ${sd_name} -pin_names {"MDDR_ADDR" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_ADDR" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MDDR_BA" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_BA" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MDDR_DM_RDQS" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_DM_RDQS" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MDDR_DQ" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_DQ" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MDDR_DQS" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_DQS" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MSS_INT_F2M" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MSS_INT_F2M" }

# Add bus interface net connections
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORECONFIGP_0:MDDR_APBmslave" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_APB_SLAVE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_0_AMBA_MASTER" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:FIC_0_AHB_MASTER" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"FIC_0_AMBA_SLAVE" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:FIC_0_AHB_SLAVE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"MDDR_DDR_AMBA_SLAVE" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:MDDR_DDR_AHB0_SLAVE" }
sd_connect_pins -sd_name ${sd_name} -pin_names {"CORECONFIGP_0:FIC_2_APBmmaster" "MSS_SUBSYSTEM_sb_0_sb_MSS_0:FIC_2_APB_MASTER" }
...
generate_design -component {MSS_SUBSYSTEM_sb_0_sb_MSS} -library {} -file {} -generator {} -recursive 1 
sd_update_instance -sd_name ${sd_name} -instance_name {MSS_SUBSYSTEM_sb_0_sb_MSS_0}
# Generate SmartDesign MSS_SUBSYSTEM_sb_0_sb
set_root MSS_SUBSYSTEM_sb_0_sb
generate_component -component_name ${sd_name}
