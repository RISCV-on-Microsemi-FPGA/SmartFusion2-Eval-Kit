...
proc create_new_project_label_axi { }\
{
   ...
   puts "------------SF2_EVAL_KIT_MiV_AXI_BaseDesign--------------------------"
   puts "-----------------------------------------------------------------------------------------------"
   puts "-----------------------------------------------------------------------------------------------"
}
...
proc create_new_project_label_ahb { }\
{
   ...
   puts "-----------------------------------------------------------------------------------------------"
   puts "---------------------------Creating New Project------------------------------------"
   puts "------------SF2_EVAL_KIT_MiV_AHB_BaseDesign------------------------"
   puts "-----------------------------------------------------------------------------------------------"
   puts "-----------------------------------------------------------------------------------------------"
}
...
if {"$design_flow_stage" == "SYNTHESIZE"} then {
	...
	if {"$target" == "AHB"} then {
		export_prog_job \
			-job_file_name {SF2_EVAL_KIT_MiV_AHB_BaseDesign} \
		...
		export_prog_job \
			-job_file_name {SF2_EVAL_KIT_MiV_AXI_BaseDesign} \
