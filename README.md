## SmartFusion2 Security Evaluation Kit Mi-V Sample Designs
...
To download or clone the repository:
    ...
    $ git clone https://github.com/RISCV-on-Microsemi-FPGA/SmartFusion2-Eval-Kit.git
...
## Target Hardware
Details of the SmartFusion2 Security Evaluation Kit and it's features can be found:
